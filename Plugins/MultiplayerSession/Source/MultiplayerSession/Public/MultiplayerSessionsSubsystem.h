...
public:
	...
	/**
	 *	To handle session functionality. The Menu class will call these functions to create, join, and destroy sessions.
	 */
	...
	/**
	 * Delegate to bind to the Menu class.
	 */
...
private:
	 ...
	 * We'll bind our MultiplayerSessionsSubsystem functions to the Online Session Interface delegates.
	 */
